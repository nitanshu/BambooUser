...
after_invitation_signup filter(s) (if defined) will be called when invitation based signup is successful.

    after_invitation_signup do |option|
        #user code
    end
    after_invitation_signup :some_method_5_to_call, :some_method_6_to_call
